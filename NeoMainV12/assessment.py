...
def get_groq_response(prompt, age, experience, conversation_history=None, client=None, retries=3, delay=2):
    """
    ...
    return get_llm_response(prompt, age, experience, conversation_history, client, retries, delay)
